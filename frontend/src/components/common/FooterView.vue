  ...
  <footer class="bg6 p-t-45 p-b-43 p-l-45 p-r-45">
    <div class="flex-w p-b-90">
      <div class="w-size6 p-t-30 p-l-15 p-r-15 respon3">
        <h4 class="s-text12 p-b-30">Developer</h4>

        <div>
          <ul>
            <li class="p-b-9">
              <a href="/" class="s-text7"> 김우건 dnrjs8185@naver.com </a>
            </li>

            <li class="p-b-9">
              <a href="/" class="s-text7"> 최영현 chlasnmzx2@naver.com </a>
            </li>
          </ul>
      ...
      <div class="w-size7 p-t-30 p-l-15 p-r-15 respon4">
        ...
        <ul>
          ...
          <li class="p-b-9">
            <a href="/qna" class="s-text7"> Q&A </a>
          </li>

          <li class="p-b-9">
            <a href="/news" class="s-text7"> News </a>
          </li>

          <li class="p-b-9">
            <a href="/house" class="s-text7"> Apt Deal </a>
          </li>
        </ul>
      </div>
